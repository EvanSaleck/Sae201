...
public class Arrivepage  extends Stage {
	...
	ObservableList<Chambre> data = FXCollections.observableArrayList(
			...
			new Chambre(321, 3, "Deluxe", "10-06-2023", "13-06-2023"),
			new Chambre(322, 3, "Petite", "07-06-2023", "18-06-2023"),
			new Chambre(320, 3, "Petite", "05-06-2023", "17-06-2023"),
			new Chambre(320, 3, "Moyenne", "12-06-2023", "20-06-2023"),
			new Chambre(320, 3, "Petite", "17-06-2023", "18-06-2023"),
			new Chambre(320, 3, "Moyenne", "20-06-2023", "21-06-2023"),
			new Chambre(320, 3, "Moyenne", "13-06-2023", "22-06-2023"));
...
// Appliquer la classe d'usine aux DatePicker
		...
		button.setOnAction(e -> {
			Stage stage = (Stage) button.getScene().getWindow(); // Récupère l'instance de Stage actuelle
